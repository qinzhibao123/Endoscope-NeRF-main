...
from endoscope.render_ray import render_rays
...
from endoscope.criterion import Criterion
...
from endoscope.data_loaders.create_training_dataset import create_training_dataset
...
def train(args):
    ...
    # Create Endoscope-NeRF model
    model = Endoscope_NeRFModel(args, load_opt=not args.no_load_opt, load_scheduler=not args.no_load_scheduler)
    # create projector
